#"""Update UserBot Code (FOR Raganrok USERBOT)
#Syntax: .update
#\nAll Credits goes to © @HELLBOY_OP
...
UPSTREAM_REPO_URL = "https://github.com/HellBoy-Aaryan/RaganrokBot.git"
...
async def upstream(ups):
    ...
    if HEROKU_API_KEY is not None:
        ...
        await ups.edit("Updating and Deploying New Update. Please wait for 5 minutes then use `.alive` to check if i'm working or not, you are my best boss...🤗🤗😎.. Just after this update a restart will take place..that's all- your Ɽǟɢǟռօʀӄɮð† by @HELLBOY_OP ")
