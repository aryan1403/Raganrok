...
pm_caption += f"⚔️**му ℓσя∂**⚔️ ☞ {DEFAULTUSER}\n"

pm_caption += "⚡️**тєℓєтнσи ʋɛʀֆɨօռ**⚡️ ☞ 1.15.0 \n"

pm_caption += "⚡️**Os**⚡️ ☞ ʟɪɴᴜx ᴍᴀɴᴅʀɪᴠᴀ \n"

pm_caption += "😈**Ɽǟɢǟռօʀӄɮð†**😈 ☞ 2.0\n"

pm_caption += "✨**ѕυρρσят ¢нαииєℓ**✨ ☞ [ᴊᴏɪɴ](https://t.me/Raganork_Official)\n"

pm_caption += "⚜️**ѕυρρσят gяσυρ**⚜️ ☞ [ᴊᴏɪɴ](https://t.me/Raganork_bot_chat)\n"
