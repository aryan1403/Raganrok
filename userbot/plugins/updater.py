...
async def upstream(ups):
    ...
    if ac_br != "master":
        await ups.edit(
            ...
            "Please checkout the official branch of Raganrok`"
        )
        repo.__del__()
        return
    ...
    if force_updateme:
        ...
        await ups.edit("`Updating Raganrok Userbot, please wait....`")
    ...
    if Var.HEROKU_API_KEY is not None:
        ...
        try:
            ...
            repo.__del__()
            return
        await ups.edit("`Successfully Updated Raganrok!\n" "Restarting, please wait...`")
    else:
        ...
        await ups.edit(
            "`Successfully Updated Your Userbot!\n" "Restarting... Wait for a 1-2 Mins!`"
        )
