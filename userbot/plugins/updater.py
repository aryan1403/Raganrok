...
OFFICIAL_UPSTREAM_REPO = "https://github.com/Hellboy-Aaryan/Raganrok.git"
BOT_IS_UP_TO_DATE = "`The Raganrok is up-to-date.\nThank you for Using this Service.`"
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("`Raganork Updation in Progress......`")
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "Raganork Updation Sucessfull ! Now Restarting To Finish This Process. Try `.alive` To Check If I Am Alive \n© @Raganork_Official"
    )
